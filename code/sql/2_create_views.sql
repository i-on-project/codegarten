...
SELECT
    ...
    name,
    description
FROM CLASSROOM LEFT JOIN INVITECODE ON (CLASSROOM.cid = INVITECODE.cid AND type = 'classroom');
...
FROM ASSIGNMENT JOIN CLASSROOM ON (ASSIGNMENT.cid = CLASSROOM.cid) LEFT JOIN INVITECODE ON (ASSIGNMENT.aid = INVITECODE.aid);
