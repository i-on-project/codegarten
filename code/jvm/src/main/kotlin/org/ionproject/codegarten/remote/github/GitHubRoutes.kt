...
object GitHubRoutes {
    ...
    // Repositories
    const val GITHUB_REPOS_SEARCH = "$GITHUB_API_HOST/search/repositories"
    ...
    fun searchGitHubReposInOrgUri(orgName: String, toSearch: String)
        = "$GITHUB_REPOS_SEARCH?q=$toSearch+org:$orgName"
